...
PANDASBI_SETUP_MESSAGE = (
    ...
    "or by setting the DATAHORSE_API_KEY environment variable. To get the key follow below steps:\n"
    "1. Go to datahorse.ai and sign up\n"
    "2. From settings go to API keys and copy\n"
    "3. Set environment variable like os.environ['DATAHORSE_API_KEY'] = '$2a$10$flb7....'"
)
