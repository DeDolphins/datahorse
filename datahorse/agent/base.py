...
import datahorse.pandas as pd
from datahorse.agent.base_security import BaseSecurity
from datahorse.llm.bamboo_llm import BambooLLM
from datahorse.pipelines.chat.chat_pipeline_input import ChatPipelineInput
from datahorse.pipelines.chat.code_execution_pipeline_input import (
...
class BaseAgent:
    ...
    def __init__(
        ...
        if self._vectorstore is None and os.environ.get("DATAHORSE_API_KEY"):
            try:
                from datahorse.vectorstores.bamboo_vectorstore import BambooVectorStore
